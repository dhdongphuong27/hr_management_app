            ...
            <div class="row">
                <div class="col-9">
                    <div class="form_container">
                        <form action="add_employee_submit.php" method="post" class="createAccForm">
                            <div class="form-group">
                                <label for="fullname"><b>Employee Full Name</b></label>
                                <input type="text" class="form-control" name="fullname" id="fullname" aria-describedby="name"
                            ...
                            <hr>
                            <button type="submit" name="add_employee" id="add_btn" class="btn custombtn">Create</button>
                        </form>
                    </div>
